...
class MainWindow : public QMainWindow {
    ...
    private:
        ...
        void finalizeCrudUpdate(const QVector<Event> &updatedEvents, const QString &statusMessage, const QString &preferredOccurrenceKey = QString(),
        ...
        void applyOccurrenceRowState(QTableWidget *table, int row, const EventOccurrence &occurrence, int accentColumn, bool selected) const;
